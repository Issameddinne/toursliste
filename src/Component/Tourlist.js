...
import TourCrad from './TourCrad'
import Addtour from './Addtour'

const Tourlist = ({price}) => {
  ...
  return (
    <div>
    <Addtour tours={tours} setTours={setTours}/>
      {
        tours.reverse().filter((el)=> price===5000? el:price<el.price).map((tour)=><TourCrad tour={tour}/>)
      }
    </div>
  )
}
